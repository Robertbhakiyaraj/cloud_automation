...
output "des_name" {
    value = azurerm_disk_encryption_set.des_db.name
}
...
output "name_id" {
    value = azurerm_disk_encryption_set.des_db.id
}

output "key_name" {
    value = azurerm_key_vault_key.des_key_db.name
}

output "versionless_id" {
    value = azurerm_key_vault_key.des_key_db.versionless_id
}
